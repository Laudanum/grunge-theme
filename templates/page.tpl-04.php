<?php
// $Id: page.tpl-04.php,v 1.1 2010/09/11 20:29:12 atelier Exp $
?>
...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <div id="main-wrapper" class="main-wrapper <?php print theme_get_setting('sidebar_layout'); ?>-<?php print $sidebar_first_width; ?>-<?php print $sidebar_last_width; ?> full-width">
